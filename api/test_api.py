...
class OTPVerificationAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="testuser", email="test@example.com", password="testpass123", is_verified=False
        )
...
class PasswordResetAPITest(APITestCase):
    ...
    def test_initiate_forgot_password_unverified_user(self):
        ...
        unverified_user = User.objects.create_user(
            username="unverified", email="unverified@example.com", password="testpass123", is_verified=False
        )
